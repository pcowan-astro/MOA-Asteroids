#Architecture for MOA12 as described in Towards Asteroid Detection in Microlensing Surveys with Deep Learning by Cowan et al.

import tensorflow as tf
from tensorflow.keras.layers import Conv2D, Dense, MaxPooling2D, Dropout, Flatten, Input

class MOA12(tf.keras.Model):
    def __init__(self, inputs):
        super(MOA12, self).__init__()
